...
function borderCreate(nickname, img, title, content, back) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/bordercreact",
      data: {
        nickname,
        img,
        title,
...
function borderCount() {
  return async (dispatch, getState) => {
    const user = await axios({
      method: "post",
      url: "http://52.78.111.36:8000/border",
    })
      .then((e) => {
        const userData = e.data;
        dispatch(Border.border({ userData }));
...
function borderShow(id) {
  return async (dispatch, getState) => {
    const user = await axios({
      method: "post",
      url: "http://52.78.111.36:8000/bordershow",
      data: {
        id,
      },
    })
...
function borderDelete(id) {
  return async (dispatch, getState) => {
    const user = await axios({
      method: "post",
      url: "http://52.78.111.36:8000/borderdelete",
      data: {
        id,
      },
    })
...
function borderUpdate(id, title, content) {
  return async (dispatch, getState) => {
    const user = await axios({
      method: "post",
      url: "http://52.78.111.36:8000/borderupdate",
      data: {
        id,
        title,
        content,
...
function replies(borderid, nickname, profil, content) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/replie",
      data: {
        borderid,
        nickname,
        profil,
...
function repliesShow(borderid) {
  return async (dispatch, getState) => {
    const user = await axios({
      method: "post",
      url: "http://52.78.111.36:8000/replieshow",
      data: {
        borderid,
      },
    })
...
function repliesDelete(replies_id, border_id) {
  return async (dispatch, getState) => {
    const user = await axios({
      method: "post",
      url: "http://52.78.111.36:8000/repliesdelete",
      data: {
        replies_id,
        border_id,
      },
...
function repliesUpdate(replies_id, border_id, content) {
  return async (dispatch, getState) => {
    const user = await axios({
      method: "post",
      url: "http://52.78.111.36:8000/repliesupdate",
      data: {
        replies_id,
        border_id,
        content,
