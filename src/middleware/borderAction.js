...
function borderCreate(nickname,img,title,content,back){
    return async(dispatch,getState)=>{
        await axios({
            method : "post",
            url:"http://43.201.104.136:8000/bordercreact",
            data :{
...
function borderCount(){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136:8000/border",
        }).then((e)=>{
            const userData = e.data
            dispatch(Border.border({userData}))
        }).catch((err)=>{
...
function borderShow(id){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136:8000/bordershow",
            data :{
                id
              } 
        }).then((e)=>{
...
function borderDelete(id){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136:8000/borderdelete",
            data :{
                id
              } 
        }).then((e)=>{
...
function borderUpdate(id,title,content){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136:8000/borderupdate",
            data :{
                id,title,content
              } 
        }).then((e)=>{
...
function replies(borderid,nickname,profil,content){
    return async(dispatch,getState)=>{
        await axios({
            method : "post",
            url:"http://43.201.104.136:8000/replie",
            data :{
...
function repliesShow(borderid){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136:8000/replieshow",
            data :{
                borderid
              } 
        }).then((e)=>{
...
function repliesDelete(replies_id,border_id){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136:8000/repliesdelete",
            data :{
...
function repliesUpdate(replies_id,border_id,content){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136:8000/repliesupdate",
            data :{
