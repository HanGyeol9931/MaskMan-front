...
function borderCreate(nickname,img,title,content,back){
    return async(dispatch,getState)=>{
        await axios({
            method : "post",
            url:"http://43.201.104.136/bordercreact",
            data :{
...
function borderCount(){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136/border",
        }).then((e)=>{
            const userData = e.data
            dispatch(Border.border({userData}))
        }).catch((err)=>{
...
function borderShow(id){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136/bordershow",
            data :{
                id
              } 
        }).then((e)=>{
...
function borderDelete(id){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136/borderdelete",
            data :{
                id
              } 
        }).then((e)=>{
...
function borderUpdate(id,title,content){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136/borderupdate",
            data :{
                id,title,content
              } 
        }).then((e)=>{
...
function replies(borderid,nickname,profil,content){
    return async(dispatch,getState)=>{
        await axios({
            method : "post",
            url:"http://43.201.104.136/replie",
            data :{
...
function repliesShow(borderid){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136/replieshow",
            data :{
                borderid
              } 
        }).then((e)=>{
...
function repliesDelete(replies_id,border_id){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136/repliesdelete",
            data :{
...
function repliesUpdate(replies_id,border_id,content){
    return async(dispatch,getState)=>{
        const user = await axios({
            method : "post",
            url:"http://43.201.104.136/repliesupdate",
            data :{
