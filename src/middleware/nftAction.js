...
function nftData() {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/nft",
    })
      .then((e) => {
...
function nftSell(price, img, name, nickname, user_profil) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/nftsell",
      data: {
        price,
        img,
        name,
...
function nftBuy(id, price, name, nickname, writer) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/nftbuy",
      data: {
        id,
        price,
        name,
...
function nftStaking(name, nickname) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/nftstaking",
      data: {
        name,
        nickname,
      },
...
function nftNonstaking(name, nickname) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/nftnonstaking",
      data: {
        name,
        nickname,
      },
...
function stakingCheck(nickname) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/stakingcheck",
      data: {
        nickname,
      },
    })
...
function stakingPoint(nickname, stakingpoint, userpoint) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/stakingPoint",
      data: {
        nickname,
        stakingpoint,
        userpoint,
...
function imgUpload(formData, config) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/imgupload",
      data: formData,
      config,
    })
      .then((e) => {
...
function usersData() {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/usersdata",
    })
      .then((e) => {
...
function usersChange(nickname, type) {
  return async (dispatch, getState) => {
    await axios({
      method: "post",
      url: "http://52.78.111.36:8000/userschange",
      data: { nickname, type },
    })
      .then((e) => {
        const users = e.data.users;
